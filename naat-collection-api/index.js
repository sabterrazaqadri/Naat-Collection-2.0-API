...
app.get('/api/hamd', (req, res) => {
  ...
  res.json(hamds); // Respond with JSON data
});

// Route 2: /api/naat
app.get('/api/naat', (req, res) => {
  const naats = [];
  res.json(naats); // Respond with JSON data
});

// Root route
app.get('/', (req, res) => {
  res.send('Welcome to the Naat Collection API');
});
